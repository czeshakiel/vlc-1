                  ...
                  <?php               
                        ...
                        foreach($trainee as $branch){
                            ...
                            echo "<tr>";
                                ...
                                ?>
                                <a href="<?=base_url();?>delete_trainee/<?=$branch['controlno'];?>/<?=str_replace(',','',$branch['lastname']);?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this record?');return false;">Delete</a>
                                <?php
                                echo "</td>";                                
                            echo "</tr>";
                            $x++;
